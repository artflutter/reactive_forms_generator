...
class AnnotatelessForm implements FormModel<Annotateless, Annotateless> {
  ...
  Annotateless? _ownInitialModel;

  late Map<String, Object?> _ownInitialRawValue = AnnotatelessForm.formElements(
    _ownInitialModel,
  ).rawValue;
