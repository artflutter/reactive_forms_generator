...
class PersonalOForm implements FormModel<PersonalO, PersonalOOutput> {
  ...
  PersonalO? _ownInitialModel;

  late Map<String, Object?> _ownInitialRawValue = PersonalOForm.formElements(
    _ownInitialModel,
  ).rawValue;
  ...
  PersonalO? get initialModel {
    return _ownInitialModel;
  }

  void commitInitial([PersonalO? newModel]) {
    _ownInitialModel = newModel ?? rawModel;
    _ownInitialRawValue = PersonalOForm.formElements(_ownInitialModel).rawValue;
  }
...
class PhoneOForm implements FormModel<PhoneO, PhoneOOutput> {
  PhoneOForm(this.form, this.path, this._formModel, {PhoneO? initialModel})
    : _ownInitialModel = initialModel;
  ...
  PhoneO? _ownInitialModel;

  late Map<String, Object?> _ownInitialRawValue = PhoneOForm.formElements(
    _ownInitialModel,
  ).rawValue;
  ...
  PhoneO? get initialModel {
    return _ownInitialModel;
  }

  void commitInitial([PhoneO? newModel]) {
    _ownInitialModel = newModel ?? rawModel;
    _ownInitialRawValue = PhoneOForm.formElements(_ownInitialModel).rawValue;
  }
