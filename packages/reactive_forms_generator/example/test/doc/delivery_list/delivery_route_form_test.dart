...
void main() {
  group('DeliveryListForm Tests', () {
    ...
    testWidgets(
      'Add two items and update values',
      (WidgetTester tester) async {
        late DeliveryList testModel;
        await tester.pumpWidget(
          MaterialApp(
    ...
    testWidgets(
      'Update values on empty form and insert between them',
      (WidgetTester tester) async {
        late DeliveryList testModel;
        await tester.pumpWidget(
          MaterialApp(
