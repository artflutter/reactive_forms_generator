...
class MSICreateForm implements FormModel<MSICreate, MSICreateOutput> {
  ...
  FormGroupWrapper get companyAddress =>
      FormGroupWrapper(form.control(companyAddressControlPath()) as FormGroup);

  FormGroupWrapper get primaryContact =>
      FormGroupWrapper(form.control(primaryContactControlPath()) as FormGroup);

  FormGroupWrapper get mailingAddress =>
      FormGroupWrapper(form.control(mailingAddressControlPath()) as FormGroup);
