...
class LoginExtendedNullableForm
  ...
  LoginExtendedNullableForm(
    ...
    this.path,
    this._formModel, {
    LoginExtendedNullable? initialModel,
  ...
  LoginExtendedNullable? _ownInitialModel;

  late Map<String, Object?> _ownInitialRawValue =
      LoginExtendedNullableForm.formElements(_ownInitialModel).rawValue;
  ...
  LoginExtendedNullable? get initialModel {
    return _ownInitialModel;
  }

  void commitInitial([LoginExtendedNullable? newModel]) {
    _ownInitialModel = newModel ?? rawModel;
    _ownInitialRawValue = LoginExtendedNullableForm.formElements(
      _ownInitialModel,
    ).rawValue;
  }
