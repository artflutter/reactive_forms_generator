...
class UserProfileForm implements FormModel<UserProfile, UserProfile> {
  UserProfileForm(this.form, this.path);
  ...
  FormGroupWrapper get home =>
      FormGroupWrapper(form.control(homeControlPath()) as FormGroup);

  FormGroupWrapper get office =>
      FormGroupWrapper(form.control(officeControlPath()) as FormGroup);
