...
class ModelExtendsForm implements FormModel<ModelExtends, ModelExtends> {
  ...
  ModelExtends? _ownInitialModel;

  late Map<String, Object?> _ownInitialRawValue = ModelExtendsForm.formElements(
    _ownInitialModel,
  ).rawValue;
