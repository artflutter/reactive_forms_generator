...
_SubGroupO _$SubGroupOFromJson(Map<String, dynamic> json) =>
    _SubGroupO(id: json['id'] as String);
...
_SubGroupOOutput _$SubGroupOOutputFromJson(Map<String, dynamic> json) =>
    _SubGroupOOutput(id: json['id'] as String);
...
Map<String, dynamic> _$GroupOOutputToJson(_GroupOOutput instance) =>
    <String, dynamic>{'id': instance.id, 'subGroupList': instance.subGroupList};
...
Map<String, dynamic> _$NestedOOutputToJson(_NestedOOutput instance) =>
    <String, dynamic>{'groupList': instance.groupList};
