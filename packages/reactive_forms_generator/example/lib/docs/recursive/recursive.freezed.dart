  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.parcelSystem, parcelSystem) ||
                other.parcelSystem == parcelSystem) &&
            const DeepCollectionEquality()
                .equals(other.subSecuredAreas, subSecuredAreas));
  }

  @override
  int get hashCode => Object.hash(runtimeType, id, securedArea, parcelSystem,
    ...
    return _then(_self.copyWith(
      ...
      securedArea: freezed == securedArea
          ...
          : securedArea // ignore: cast_nullable_to_non_nullable
              as SecuredArea?,
      parcelSystem: freezed == parcelSystem
          ? _self.parcelSystem
          : parcelSystem // ignore: cast_nullable_to_non_nullable
              as ParcelSystem?,
...
class _SecuredArea implements SecuredArea {
  ...
  @override
  final ParcelSystem? parcelSystem;
...
mixin _$ParcelSystem {
  @RfControl<bool>()
  bool get hasParcelSystem;
  ParcelSystemData get data;

  /// Create a copy of ParcelSystem
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ParcelSystemCopyWith<ParcelSystem> get copyWith =>
      _$ParcelSystemCopyWithImpl<ParcelSystem>(
          this as ParcelSystem, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ParcelSystem &&
            (identical(other.hasParcelSystem, hasParcelSystem) ||
                other.hasParcelSystem == hasParcelSystem) &&
...
abstract mixin class $ParcelSystemCopyWith<$Res> {
  factory $ParcelSystemCopyWith(
          ParcelSystem value, $Res Function(ParcelSystem) _then) =
      _$ParcelSystemCopyWithImpl;
  @useResult
  $Res call({@RfControl<bool>() bool hasParcelSystem, ParcelSystemData data});

  $ParcelSystemDataCopyWith<$Res> get data;
}

/// @nodoc
class _$ParcelSystemCopyWithImpl<$Res> implements $ParcelSystemCopyWith<$Res> {
  ...
  @override
  $Res call({
    Object? hasParcelSystem = null,
    Object? data = null,
  }) {
    return _then(_self.copyWith(
      hasParcelSystem: null == hasParcelSystem
          ? _self.hasParcelSystem
          : hasParcelSystem // ignore: cast_nullable_to_non_nullable
              as bool,
      data: null == data
          ? _self.data
...
class _ParcelSystem implements ParcelSystem {
  const _ParcelSystem(
      {@RfControl<bool>() this.hasParcelSystem = false,
      this.data = const ParcelSystemData()});

  @override
  @JsonKey()
  @RfControl<bool>()
  final bool hasParcelSystem;
  @override
  @JsonKey()
  final ParcelSystemData data;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ParcelSystemCopyWith<_ParcelSystem> get copyWith =>
      __$ParcelSystemCopyWithImpl<_ParcelSystem>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ParcelSystem &&
            (identical(other.hasParcelSystem, hasParcelSystem) ||
                other.hasParcelSystem == hasParcelSystem) &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class _$ParcelSystemCopyWith<$Res>
    implements $ParcelSystemCopyWith<$Res> {
  factory _$ParcelSystemCopyWith(
          _ParcelSystem value, $Res Function(_ParcelSystem) _then) =
      __$ParcelSystemCopyWithImpl;
  @override
  @useResult
  $Res call({@RfControl<bool>() bool hasParcelSystem, ParcelSystemData data});
...
mixin _$ParcelSystemData {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ParcelSystemDataCopyWith<ParcelSystemData> get copyWith =>
      _$ParcelSystemDataCopyWithImpl<ParcelSystemData>(
          this as ParcelSystemData, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ParcelSystemData &&
            (identical(other.id, id) || other.id == id));
  }
...
abstract mixin class $ParcelSystemDataCopyWith<$Res> {
  factory $ParcelSystemDataCopyWith(
          ParcelSystemData value, $Res Function(ParcelSystemData) _then) =
      _$ParcelSystemDataCopyWithImpl;
  @useResult
  $Res call({String? id});
}
...
class _ParcelSystemData implements ParcelSystemData {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ParcelSystemDataCopyWith<_ParcelSystemData> get copyWith =>
      __$ParcelSystemDataCopyWithImpl<_ParcelSystemData>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ParcelSystemData &&
            (identical(other.id, id) || other.id == id));
  }
...
/// @nodoc
abstract mixin class _$ParcelSystemDataCopyWith<$Res>
    implements $ParcelSystemDataCopyWith<$Res> {
  factory _$ParcelSystemDataCopyWith(
          _ParcelSystemData value, $Res Function(_ParcelSystemData) _then) =
      __$ParcelSystemDataCopyWithImpl;
  @override
  @useResult
  $Res call({String? id});
}
