...
@RfControl<String>() String get title;@RfControl<String>() String? get description;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Test&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description));
}
...
@useResult
$Res call({
@RfControl<String>() String title,@RfControl<String>() String? description
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@RfControl<String>()  String title, @RfControl<String>()  String? description)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Test() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@RfControl<String>()  String title, @RfControl<String>()  String? description)  $default,) {final _that = this;
switch (_that) {
case _Test():
return $default(_that.title,_that.description);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@RfControl<String>()  String title, @RfControl<String>()  String? description)?  $default,) {final _that = this;
switch (_that) {
case _Test() when $default != null:
return $default(_that.title,_that.description);case _:
  return null;
...
class _Test extends Test {
  const _Test({@RfControl<String>() required this.title, @RfControl<String>() this.description}): super._();
  

@override@RfControl<String>() final  String title;
@override@RfControl<String>() final  String? description;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Test&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description));
}
