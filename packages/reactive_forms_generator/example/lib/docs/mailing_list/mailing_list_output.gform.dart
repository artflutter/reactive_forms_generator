...
class MailingListOForm implements FormModel<MailingListO, MailingListOOutput> {
  ...
  MailingListO? _ownInitialModel;

  late Map<String, Object?> _ownInitialRawValue = MailingListOForm.formElements(
    _ownInitialModel,
  ).rawValue;
