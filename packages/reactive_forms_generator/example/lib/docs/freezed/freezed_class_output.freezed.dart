...
@RfControl<String>() String? get gender;@RfControl(validators: [RequiredValidator()]) String? get genderR;@RfControl() String? get id;@RfControl(validators: [RequiredValidator()]) String? get idR;@RfControl(validators: [RequiredValidator()]) String get idR2;@RfControl<String>() String? get name;@JsonKey(name: 'logo_image')@RfControl<String>() String? get logoImage;@RfControl<double>() double? get year; List<String> get selectedSpaces;
/// Create a copy of FreezedClassO
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FreezedClassOCopyWith<FreezedClassO> get copyWith => _$FreezedClassOCopyWithImpl<FreezedClassO>(this as FreezedClassO, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FreezedClassO&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.genderR, genderR) || other.genderR == genderR)&&(identical(other.id, id) || other.id == id)&&(identical(other.idR, idR) || other.idR == idR)&&(identical(other.idR2, idR2) || other.idR2 == idR2)&&(identical(other.name, name) || other.name == name)&&(identical(other.logoImage, logoImage) || other.logoImage == logoImage)&&(identical(other.year, year) || other.year == year)&&const DeepCollectionEquality().equals(other.selectedSpaces, selectedSpaces));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,gender,genderR,id,idR,idR2,name,logoImage,year,const DeepCollectionEquality().hash(selectedSpaces));
...
abstract mixin class $FreezedClassOCopyWith<$Res>  {
  factory $FreezedClassOCopyWith(FreezedClassO value, $Res Function(FreezedClassO) _then) = _$FreezedClassOCopyWithImpl;
@useResult
$Res call({
@RfControl<String>() String? gender,@RfControl(validators: [RequiredValidator()]) String? genderR,@RfControl() String? id,@RfControl(validators: [RequiredValidator()]) String? idR,@RfControl(validators: [RequiredValidator()]) String idR2,@RfControl<String>() String? name,@JsonKey(name: 'logo_image')@RfControl<String>() String? logoImage,@RfControl<double>() double? year, List<String> selectedSpaces
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FreezedClassO value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FreezedClassO value)  $default,){
final _that = this;
switch (_that) {
case _FreezedClassO():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FreezedClassO value)?  $default,){
final _that = this;
switch (_that) {
case _FreezedClassO() when $default != null:
return $default(_that);case _:
...
switch (_that) {
case _FreezedClassO() when $default != null:
return $default(_that.gender,_that.genderR,_that.id,_that.idR,_that.idR2,_that.name,_that.logoImage,_that.year,_that.selectedSpaces);case _:
  return orElse();
...
@override@RfControl(validators: [RequiredValidator()]) final  String? genderR;
@override@RfControl() final  String? id;
@override@RfControl(validators: [RequiredValidator()]) final  String? idR;
@override@JsonKey()@RfControl(validators: [RequiredValidator()]) final  String idR2;
...
@pragma('vm:prefer-inline')
_$FreezedClassOCopyWith<_FreezedClassO> get copyWith => __$FreezedClassOCopyWithImpl<_FreezedClassO>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$FreezedClassOToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FreezedClassO&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.genderR, genderR) || other.genderR == genderR)&&(identical(other.id, id) || other.id == id)&&(identical(other.idR, idR) || other.idR == idR)&&(identical(other.idR2, idR2) || other.idR2 == idR2)&&(identical(other.name, name) || other.name == name)&&(identical(other.logoImage, logoImage) || other.logoImage == logoImage)&&(identical(other.year, year) || other.year == year)&&const DeepCollectionEquality().equals(other._selectedSpaces, _selectedSpaces));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,gender,genderR,id,idR,idR2,name,logoImage,year,const DeepCollectionEquality().hash(_selectedSpaces));
...
/// @nodoc
abstract mixin class _$FreezedClassOCopyWith<$Res> implements $FreezedClassOCopyWith<$Res> {
  factory _$FreezedClassOCopyWith(_FreezedClassO value, $Res Function(_FreezedClassO) _then) = __$FreezedClassOCopyWithImpl;
@override @useResult
$Res call({
@RfControl<String>() String? gender,@RfControl(validators: [RequiredValidator()]) String? genderR,@RfControl() String? id,@RfControl(validators: [RequiredValidator()]) String? idR,@RfControl(validators: [RequiredValidator()]) String idR2,@RfControl<String>() String? name,@JsonKey(name: 'logo_image')@RfControl<String>() String? logoImage,@RfControl<double>() double? year, List<String> selectedSpaces
});
...
/// Create a copy of FreezedClassO
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? gender = freezed,Object? genderR = freezed,Object? id = freezed,Object? idR = freezed,Object? idR2 = null,Object? name = freezed,Object? logoImage = freezed,Object? year = freezed,Object? selectedSpaces = null,}) {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FreezedClassOOutputCopyWith<FreezedClassOOutput> get copyWith => _$FreezedClassOOutputCopyWithImpl<FreezedClassOOutput>(this as FreezedClassOOutput, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FreezedClassOOutput&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.genderR, genderR) || other.genderR == genderR)&&(identical(other.id, id) || other.id == id)&&(identical(other.idR, idR) || other.idR == idR)&&(identical(other.idR2, idR2) || other.idR2 == idR2)&&(identical(other.name, name) || other.name == name)&&(identical(other.logoImage, logoImage) || other.logoImage == logoImage)&&(identical(other.year, year) || other.year == year)&&const DeepCollectionEquality().equals(other.selectedSpaces, selectedSpaces));
}
...
abstract mixin class $FreezedClassOOutputCopyWith<$Res>  {
  factory $FreezedClassOOutputCopyWith(FreezedClassOOutput value, $Res Function(FreezedClassOOutput) _then) = _$FreezedClassOOutputCopyWithImpl;
@useResult
$Res call({
@RfControl<String>() String? gender,@RfControl(validators: [RequiredValidator()]) String genderR,@RfControl() String? id,@RfControl(validators: [RequiredValidator()]) String idR,@RfControl(validators: [RequiredValidator()]) String idR2,@RfControl<String>() String? name,@JsonKey(name: 'logo_image')@RfControl<String>() String? logoImage,@RfControl<double>() double? year, List<String> selectedSpaces
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FreezedClassOOutput value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FreezedClassOOutput value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FreezedClassOOutput value)?  $default,){
final _that = this;
switch (_that) {
case _FreezedClassOOutput() when $default != null:
return $default(_that);case _:
...
@override@RfControl() final  String? id;
@override@RfControl(validators: [RequiredValidator()]) final  String idR;
@override@RfControl(validators: [RequiredValidator()]) final  String idR2;
@override@RfControl<String>() final  String? name;
@override@JsonKey(name: 'logo_image')@RfControl<String>() final  String? logoImage;
@override@RfControl<double>() final  double? year;
 final  List<String> _selectedSpaces;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$FreezedClassOOutputCopyWith<_FreezedClassOOutput> get copyWith => __$FreezedClassOOutputCopyWithImpl<_FreezedClassOOutput>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$FreezedClassOOutputToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FreezedClassOOutput&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.genderR, genderR) || other.genderR == genderR)&&(identical(other.id, id) || other.id == id)&&(identical(other.idR, idR) || other.idR == idR)&&(identical(other.idR2, idR2) || other.idR2 == idR2)&&(identical(other.name, name) || other.name == name)&&(identical(other.logoImage, logoImage) || other.logoImage == logoImage)&&(identical(other.year, year) || other.year == year)&&const DeepCollectionEquality().equals(other._selectedSpaces, _selectedSpaces));
}
...
/// @nodoc
abstract mixin class _$FreezedClassOOutputCopyWith<$Res> implements $FreezedClassOOutputCopyWith<$Res> {
  factory _$FreezedClassOOutputCopyWith(_FreezedClassOOutput value, $Res Function(_FreezedClassOOutput) _then) = __$FreezedClassOOutputCopyWithImpl;
@override @useResult
$Res call({
@RfControl<String>() String? gender,@RfControl(validators: [RequiredValidator()]) String genderR,@RfControl() String? id,@RfControl(validators: [RequiredValidator()]) String idR,@RfControl(validators: [RequiredValidator()]) String idR2,@RfControl<String>() String? name,@JsonKey(name: 'logo_image')@RfControl<String>() String? logoImage,@RfControl<double>() double? year, List<String> selectedSpaces
});
...
/// Create a copy of FreezedClassOOutput
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? gender = freezed,Object? genderR = null,Object? id = freezed,Object? idR = null,Object? idR2 = null,Object? name = freezed,Object? logoImage = freezed,Object? year = freezed,Object? selectedSpaces = null,}) {
