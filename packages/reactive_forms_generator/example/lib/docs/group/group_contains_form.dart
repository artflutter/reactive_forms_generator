...
class GroupContainsFormWidget extends StatelessWidget {
  const GroupContainsFormWidget({super.key});
            ...
            children: [
              ...
              ReactiveFormConsumer(
                builder: (context, formGroup, child) {
                  if (!formModel.containsAddress) {
                    return FilledButton(
                      onPressed: () {
                        formModel.form.addAll({
                          formModel.addressControlPath():
                              AddressForm.formElements(Address()),
                        });
                      },
                      child: Text('Put back'),
                    );
              ...
              ElevatedButton(
                onPressed: () {
                  debugPrint(formModel.rawModel.address.toString());
                  formModel.submit(
                    onValid: (model) {
