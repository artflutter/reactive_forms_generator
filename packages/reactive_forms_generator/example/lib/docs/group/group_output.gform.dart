...
class GroupOForm implements FormModel<GroupO, GroupOOutput> {
  GroupOForm(this.form, this.path);
  ...
  FormGroupWrapper get personal =>
      FormGroupWrapper(form.control(personalControlPath()) as FormGroup);

  FormGroupWrapper get phone =>
      FormGroupWrapper(form.control(phoneControlPath()) as FormGroup);

  FormGroupWrapper get address =>
      FormGroupWrapper(form.control(addressControlPath()) as FormGroup);

  FormGroupWrapper get address2 =>
      FormGroupWrapper(form.control(address2ControlPath()) as FormGroup);
...
class PersonalOForm implements FormModel<PersonalO, PersonalOOutput> {
  PersonalOForm(this.form, this.path);
...
class PhoneOForm implements FormModel<PhoneO, PhoneOOutput> {
  PhoneOForm(this.form, this.path);
  ...
  FormControlWrapper<String> get phoneNumber => FormControlWrapper<String>(
    form.control(phoneNumberControlPath()) as FormControl<String>,
  );

  FormControlWrapper<String> get countryIso => FormControlWrapper<String>(
    form.control(countryIsoControlPath()) as FormControl<String>,
  );
