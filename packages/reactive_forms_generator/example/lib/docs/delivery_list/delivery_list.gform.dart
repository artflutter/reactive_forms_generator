...
class _DeliveryListFormBuilderState extends State<DeliveryListFormBuilder> {
  ...
  void initState() {
    _formModel = DeliveryListForm(
        DeliveryListForm.formElements(widget.model), null, null);
...
// ignore: unused_field
  ...
  void updateValue(
    ...
    bool emitEvent = true,
      ...
      currentForm.updateValue(DeliveryListForm.formElements(value).rawValue,
          updateParent: updateParent, emitEvent: emitEvent);
...
// ignore: unused_field
  ...
  void updateValue(
    ...
    bool emitEvent = true,
      ...
      currentForm.updateValue(DeliveryPointForm.formElements(value).rawValue,
          updateParent: updateParent, emitEvent: emitEvent);
...
// ignore: unused_field
  ...
  void updateValue(
    ...
    bool emitEvent = true,
      ...
      currentForm.updateValue(ClientForm.formElements(value).rawValue,
          updateParent: updateParent, emitEvent: emitEvent);
