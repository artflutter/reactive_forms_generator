...
class FormGroupGenerator extends FormElementGenerator {
  ...
  final ClassElement formGroupField;
  ...
  ConstructorElement? get constructorElement {
    return formGroupField.constructors.firstOrNull;
  }

  @override
  Element get fieldElement => formGroupField.thisType.element;

  ClassElement get classElement =>
      formGroupField.thisType.element as ClassElement;
